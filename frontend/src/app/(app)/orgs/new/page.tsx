...
export default function NewOrgPage() {
  ...
  return (
    <div className="mx-auto max-w-lg">
      <Link
        href="/dashboard"
        className="mb-6 inline-flex items-center gap-1.5 text-body-sm text-ink-mute hover:text-ink"
      >
      ...
      <header className="mb-10">
        <p className="tracking-overline text-overline uppercase text-ink-mute">조직</p>
        <h1 className="font-display mt-1 text-h1">교회 만들기<span className="text-coral">.</span></h1>
